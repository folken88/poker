...
const MON = {
  ...
  aasimar_gunslinger:{ name: 'Aasimar Gunslinger', glyph: '🔫', cr: '10',  hp: 92,  ac: 21, toHit: 16, dmgDie: 8, dmgCount: 2, dmgBonus: 6,  fort: 9,  reflex: 13, attacks: 2, ranged: true, gold: [120, 240], sr: 20, atkSound: '/audio/tarkov_revolver_357_shot.mp3', resist: { electricity: 0, fire: 0.5, cold: 0.5, acid: 0.5 } },   // dual golden PISTOLS — a grounded deadeye, two shots a round (was a RELOAD sound, now an actual gunshot — Josh 2026-07-13)
  aasimar_shotgunner:{ name: 'Aasimar Shotgunner', glyph: '💥', cr: '10',  hp: 92,  ac: 21, toHit: 15, dmgDie: 8, dmgCount: 1, dmgBonus: 6,  fort: 9,  reflex: 13, attacks: 1, ranged: true, gold: [120, 240], sr: 20, hellfire: { count: 1, dice: 4, die: 6, dc: 18, dtype: 'physical', verb: 'unloads a SPRAY of holy buckshot across the party', sound: '/audio/tarkov_mp153_shotgun.mp3' }, atkSound: '/audio/tarkov_mp153_shotgun.mp3', resist: { electricity: 0, fire: 0.5, cold: 0.5, acid: 0.5 } },   // a golden SHOTGUN — scatter blast (Reflex half); its scatter was SILENT (hellfire had no sound) — now a real shotgun boom (Josh 2026-07-13)
