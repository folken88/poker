...
const SPELL = {
  ...
  // v3.37.86 (Josh, dapper-moose): desc now lists exactly what the engine ENFORCES —
  // paralysis (melee riders AND Hold spells), stun, sicken, blind. The old "immune to
  // critical hits" line promised nothing: enemy attacks don't roll crits in this engine.
  elementalbody: { key: 'elementalbody', name: 'Elemental Body',  icon: '🌪️', effect: 'buff', target: 'self', elemBody: true, sticky: true, slvl: 4, sound: S.invoke, desc: 'Become a being of raw element — IMMUNE to paralysis and hold, stun, sickening & blinding, for the rest of the room.' },
