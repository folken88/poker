...
const CUSTOM_WEAPONS = {
  ...
  // v3.37.125 (Toby: more druid forms, from the bestiary's own animals):
  form_lion:       { key: 'form_lion',       name: 'Lion Claws & Bite',     cat: 'light', ranged: false, dmgCount: 1, dmgDie: 6,  crit: 20, mult: 2, type: 'S', group: 'natural', prof: 'simple', custom: true, naturalAttacks: 3, noShield: true, atkSound: '/audio/enemy_yak.mp3' },
  form_ape:        { key: 'form_ape',        name: 'Dire Ape Fists',        cat: 'light', ranged: false, dmgCount: 1, dmgDie: 6,  crit: 20, mult: 2, type: 'B', group: 'natural', prof: 'simple', custom: true, naturalAttacks: 2, noShield: true, reachFly: true, atkSound: '/audio/weapon_blunt.mp3' },
  form_boar:       { key: 'form_boar',       name: 'Boar Gore',             cat: 'light', ranged: false, dmgCount: 1, dmgDie: 8,  crit: 20, mult: 2, type: 'P', group: 'natural', prof: 'simple', custom: true, naturalAttacks: 1, noShield: true, atkSound: '/audio/bear_growl_hit.mp3' },
  form_croc:       { key: 'form_croc',       name: 'Crocodile Bite',        cat: 'light', ranged: false, dmgCount: 1, dmgDie: 12, crit: 20, mult: 2, type: 'P', group: 'natural', prof: 'simple', custom: true, naturalAttacks: 1, noShield: true, atkSound: '/audio/enemy_caimon_bite.mp3' },
