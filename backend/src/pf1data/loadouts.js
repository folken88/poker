...
const PRIORITY = {
  ...
  druid: ['curelight', 'curemoderate', 'barkskin', 'entangle', 'shockinggrasp', 'calllightning', 'lightningbolt', 'dispelmagic', 'bullsstrength', 'catsgrace', 'bearsendurance', 'magicfang', 'removeparalysis', 'reincarnate', 'riverofwind', 'firesnake', 'chainlightning', 'ironskin', 'firestorm', 'stormofvengeance'],
