...
const PRIORITY = {
  ...
  bard: ['curelight', 'curemoderate', 'haste', 'dispelmagic', 'glitterdust', 'hideouslaughter', 'grease', 'sleep', 'heroism', 'goodhope', 'slow', 'soundburst', 'charmperson', 'vanish', 'bullsstrength', 'catsgrace', 'bearsendurance', 'dominateperson', 'heroismgreater', 'masssuggestion', 'blindness', 'dazemonster', 'shout'],
