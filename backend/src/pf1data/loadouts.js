...
const PRIORITY = {
  ...
  ranger: [],
  sorcerer: ['magicmissile', 'fireball', 'haste', 'wallfire', 'mirrorimage', 'dispelmagic', 'scorchingray', 'glitterdust', 'web', 'burninghands', 'shield', 'magearmor', 'sleep', 'aciddart', 'catsgrace', 'darkness', 'gustofwind', 'protevil', 'fly', 'slow', 'holdperson', 'stoneskin', 'blacktentacles', 'invisgreater', 'coneofcold', 'cloudkill', 'suffocation', 'disintegrate', 'chainlightning', 'delayedfireball', 'fingerofdeath', 'horridwilting', 'polarray', 'meteorswarm', 'wailbanshee', 'overlandflight', 'firesnake', 'infernalhealgreater', 'riverofwind', 'stoneskincomm', 'freezingsphere', 'dominatemonster', 'waveexhaustion', 'prismaticspray', 'sunburst', 'blindness', 'dazemonster', 'falselife', 'stinkingcloud', 'icestorm', 'shout', 'rayenfeeble', 'enlargeperson', 'holdmonster', 'fleshtostone', 'undeathtodeath', 'massholdperson', 'firebrand', 'pwblind', 'mindblank', 'maze', 'pwstun', 'massholdmonster', 'pwkill', 'foresight', 'summonmonster4', 'summonmonster6', 'summonmonster8', 'timestop', 'wish', 'rayofexhaustion', 'bestowcurse', 'obscuringmist', 'heroism', 'irresistibledance', 'solidfog', 'wallice', 'wallforce'],
  bard: ['curelight', 'curemoderate', 'haste', 'mirrorimage', 'dispelmagic', 'glitterdust', 'hideouslaughter', 'grease', 'sleep', 'heroism', 'goodhope', 'slow', 'soundburst', 'charmperson', 'vanish', 'bullsstrength', 'catsgrace', 'bearsendurance', 'dominateperson', 'heroismgreater', 'masssuggestion', 'blindness', 'dazemonster', 'shout', 'holdmonster', 'masscurelight', 'irresistibledance', 'silence', 'holdperson', 'masscuremoderate'],
