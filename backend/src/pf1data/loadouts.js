...
const PRIORITY = {
  cleric: ['curelight', 'curemoderate', 'cureserious', 'curecritical', 'bless', 'divinefavor', 'shieldoffaith', 'holdperson', 'spiritweapon', 'dispelmagic', 'searinglight', 'prayer', 'bullsstrength', 'bearsendurance', 'protevil', 'divinepower', 'holysmite', 'blessingoffervor', 'protectfire', 'airwalk', 'greatermagicweapon', 'breathoflife', 'raisedead', 'resurrection', 'healspell', 'massheal', 'flamestrike', 'bladebarrier', 'firestorm', 'implosion', 'slayliving', 'righteousmight', 'magicvestment', 'unholyblight', 'doom', 'blindness', 'masscurelight', 'chainsoflight', 'masscuremoderate', 'undeathtodeath', 'plaguestorm', 'destruction', 'masscureserious', 'masscurecritical', 'summonmonster4', 'summonmonster6', 'summonmonster8', 'miracle', 'silence', 'command', 'bestowcurse', 'obscuringmist'],
  druid: ['curelight', 'curemoderate', 'barkskin', 'entangle', 'shockinggrasp', 'calllightning', 'lightningbolt', 'dispelmagic', 'bullsstrength', 'catsgrace', 'bearsendurance', 'magicfang', 'removeparalysis', 'reincarnate', 'riverofwind', 'firesnake', 'chainlightning', 'ironskin', 'firestorm', 'stormofvengeance', 'sunburst', 'flameblade', 'sleetstorm', 'airwalk', 'icestorm', 'callstorm', 'masscurelight', 'plaguestorm', 'sunbeam', 'fingerofdeath', 'foresight', 'summonnature4', 'summonnature6', 'summonnature8', 'obscuringmist', 'trueseeing', 'freedommove', 'masscuremoderate', 'wallfire'],
  wizard: ['magicmissile', 'fireball', 'haste', 'wallfire', 'mirrorimage', 'dispelmagic', 'glitterdust', 'web', 'invisibility', 'scorchingray', 'grease', 'shield', 'magearmor', 'sleep', 'shockinggrasp', 'aciddart', 'darkness', 'protevil', 'fly', 'slow', 'fear', 'holdperson', 'confusion', 'lightningbolt', 'blacktentacles', 'stoneskin', 'invisgreater', 'cloudkill', 'coneofcold', 'suffocation', 'disintegrate', 'chainlightning', 'delayedfireball', 'fingerofdeath', 'horridwilting', 'polarray', 'meteorswarm', 'wailbanshee', 'overlandflight', 'firesnake', 'infernalhealgreater', 'riverofwind', 'stoneskincomm', 'fireball_int', 'fireball_emp', 'scorch_emp', 'cone_max', 'disint_max', 'magicmissile_quick', 'freezingsphere', 'dominatemonster', 'waveexhaustion', 'prismaticspray', 'sunburst', 'blindness', 'dazemonster', 'falselife', 'stinkingcloud', 'icestorm', 'shout', 'sleetstorm', 'forcepunch', 'rayenfeeble', 'enlargeperson', 'holdmonster', 'fleshtostone', 'undeathtodeath', 'massholdperson', 'firebrand', 'pwblind', 'mindblank', 'maze', 'pwstun', 'massholdmonster', 'pwkill', 'foresight', 'summonmonster4', 'summonmonster6', 'summonmonster8', 'timestop', 'wish', 'rayofexhaustion', 'bestowcurse', 'obscuringmist', 'heroism', 'irresistibledance', 'solidfog', 'wallice', 'wallforce'],
  paladin: ['shieldoffaith', 'bullsstrength', 'prayer', 'blessingoffervor'],
  antipaladin: ['bullsstrength', 'vampirictouch'],
  ranger: [],
  sorcerer: ['magicmissile', 'fireball', 'haste', 'wallfire', 'mirrorimage', 'dispelmagic', 'scorchingray', 'glitterdust', 'web', 'burninghands', 'shield', 'magearmor', 'sleep', 'aciddart', 'catsgrace', 'darkness', 'gustofwind', 'protevil', 'fly', 'slow', 'fear', 'holdperson', 'confusion', 'stoneskin', 'blacktentacles', 'invisgreater', 'coneofcold', 'cloudkill', 'suffocation', 'disintegrate', 'chainlightning', 'delayedfireball', 'fingerofdeath', 'horridwilting', 'polarray', 'meteorswarm', 'wailbanshee', 'overlandflight', 'firesnake', 'infernalhealgreater', 'riverofwind', 'stoneskincomm', 'freezingsphere', 'dominatemonster', 'waveexhaustion', 'prismaticspray', 'sunburst', 'blindness', 'dazemonster', 'falselife', 'stinkingcloud', 'icestorm', 'shout', 'rayenfeeble', 'enlargeperson', 'holdmonster', 'fleshtostone', 'undeathtodeath', 'massholdperson', 'firebrand', 'pwblind', 'mindblank', 'maze', 'pwstun', 'massholdmonster', 'pwkill', 'foresight', 'summonmonster4', 'summonmonster6', 'summonmonster8', 'timestop', 'wish', 'rayofexhaustion', 'bestowcurse', 'obscuringmist', 'heroism', 'irresistibledance', 'solidfog', 'wallice', 'wallforce'],
  bard: ['curelight', 'curemoderate', 'haste', 'mirrorimage', 'dispelmagic', 'glitterdust', 'hideouslaughter', 'grease', 'sleep', 'heroism', 'goodhope', 'slow', 'soundburst', 'charmperson', 'vanish', 'bullsstrength', 'catsgrace', 'bearsendurance', 'dominateperson', 'heroismgreater', 'masssuggestion', 'blindness', 'dazemonster', 'shout', 'holdmonster', 'masscurelight', 'irresistibledance', 'silence', 'holdperson', 'confusion', 'masscuremoderate'],
  oracle: ['curelight', 'curemoderate', 'cureserious', 'curecritical', 'bless', 'divinefavor', 'shieldoffaith', 'holdperson', 'mirrorimage', 'invisibility', 'dispelmagic', 'searinglight', 'fireball', 'haste', 'displacement', 'prayer', 'scorchingray', 'bullsstrength', 'bearsendurance', 'darkness', 'spiritweapon', 'protevil', 'slow', 'greatermagicweapon', 'darkvisioncomm', 'holysmite', 'blessingoffervor', 'fireshield', 'invisgreater', 'protectfire', 'burninghands', 'breathoflife', 'raisedead', 'firesnake', 'resurrection', 'masscurelight', 'chainsoflight', 'masscuremoderate', 'undeathtodeath', 'plaguestorm', 'destruction', 'masscureserious', 'masscurecritical', 'summonmonster4', 'summonmonster6', 'summonmonster8', 'miracle', 'silence', 'command', 'bestowcurse', 'obscuringmist'],
  inquisitor: ['curelight', 'curemoderate', 'cureserious', 'curecritical', 'bless', 'divinefavor', 'shieldoffaith', 'holdperson', 'spiritweapon', 'dispelmagic', 'searinglight', 'prayer', 'displacement', 'bullsstrength', 'protevil', 'sleep', 'blessingoffervor', 'holysmite', 'invisgreater', 'banishment', 'dispelmagicgreater', 'divinepower', 'righteousmight', 'magicvestment', 'unholyblight', 'doom', 'silence', 'command'],
