...
const PRIORITY = {
  cleric: ['curelight', 'curemoderate', 'cureserious', 'curecritical', 'bless', 'divinefavor', 'shieldoffaith', 'holdperson', 'spiritweapon', 'dispelmagic', 'searinglight', 'prayer', 'bullsstrength', 'bearsendurance', 'protevil', 'greatermagicweapon', 'holysmite', 'blessingoffervor', 'protectfire', 'breathoflife', 'raisedead', 'resurrection'],
  druid: ['curelight', 'curemoderate', 'barkskin', 'entangle', 'shockinggrasp', 'calllightning', 'lightningbolt', 'dispelmagic', 'bullsstrength', 'catsgrace', 'bearsendurance', 'magicfang', 'removeparalysis', 'reincarnate', 'riverofwind', 'firesnake', 'chainlightning', 'ironskin'],
  ...
  inquisitor: ['curelight', 'curemoderate', 'cureserious', 'curecritical', 'bless', 'divinefavor', 'shieldoffaith', 'holdperson', 'spiritweapon', 'dispelmagic', 'searinglight', 'prayer', 'displacement', 'bullsstrength', 'protevil', 'sleep', 'blessingoffervor', 'holysmite', 'invisgreater'],
};
