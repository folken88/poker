...
const MON = {
  ...
  erinyes:           { name: 'Erinyes',           glyph: '🏹', cr: '8',   hp: 94,  ac: 24, toHit: 15, dmgDie: 8,  dmgBonus: 5,  fort: 11, reflex: 12, attacks: 2, flying: true, sr: 20, gold: [90, 190], evil: true, dr: { amount: 5, bypass: 'magic' }, resist: { fire: 0, cold: 0.5, acid: 0.5 }, atkSound: '/audio/bow_shot.mp3' },   // fallen-angel ARCHER devil — a flaming longbow on the wing (the faction's ranged specialist). AUDIBLE bow twang (was bow_silent_hits — Josh: "aint making bow noises")
