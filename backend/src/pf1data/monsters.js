...
const MON = {
  ...
  gray_ooze:         { name: 'Gray Ooze',         blindsense: true, glyph: '🟢', cr: '4',   hp: 50,  ac: 6,  toHit: 5,  dmgDie: 6,  dmgBonus: 4, fort: 6,  reflex: 0,  gold: [38, 80] },
  ...
  vampire:           { name: 'Vampire',           sr: 19, glyph: '🧛', cr: '8',   hp: 95,  ac: 22, toHit: 14, dmgDie: 6,  dmgBonus: 8, fort: 8,  reflex: 11, attacks: 2, gold: [100, 200], dr: { amount: 10, bypass: 'magic' }, evil: true, type: 'undead', shout: { fear: true, dc: 18, sound: '/audio/enemy_lich_gaze.mp3' }, spellstrike: { dice: 4, die: 6, dtype: 'negative', lifesteal: true, sound: '/audio/spell_umbral_bolt.mp3' } },   // magus of its level: dominating gaze + Vampiric Touch spellstrike (drains life). v3.37.113 (Tobias: "vampires are undead, not constructs"): the ONLY one of 13 vampires missing type:'undead' — it was also inconsistently dominable
  ...
  black_dragon:      { name: 'Black Dragon',      blindsense: true, glyph: '🐉', cr: '11',  hp: 150, ac: 26, toHit: 20, dmgDie: 6,  dmgCount: 2, dmgBonus: 9, fort: 12, reflex: 9, attacks: 2, flying: true, gold: [200, 400], evil: true, dr: { amount: 5, bypass: 'magic' }, resist: { acid: 0 }, shout: { fear: true, dc: 19, sound: '/audio/enemy_lich_gaze.mp3' },
  ...
  void_dragon:       { name: 'Void Dragon',       blindsense: true, glyph: '🐉', cr: '13',  hp: 175, ac: 27, toHit: 21, dmgDie: 8,  dmgCount: 2, dmgBonus: 9, fort: 13, reflex: 10, attacks: 2, flying: true, gold: [260, 480], evil: true, dr: { amount: 5, bypass: 'magic' }, resist: { cold: 0 }, shout: { fear: true, dc: 21, sound: '/audio/enemy_lich_gaze.mp3' },
  ...
  erinyes:           { name: 'Erinyes',           glyph: '🏹', cr: '8',   hp: 94,  ac: 24, toHit: 15, dmgDie: 8,  dmgBonus: 5,  fort: 11, reflex: 12, attacks: 2, flying: true, trueSeeing: true, sr: 20, gold: [90, 190], evil: true, dr: { amount: 5, bypass: 'magic' }, resist: { fire: 0, cold: 0.5, acid: 0.5 }, atkSound: '/audio/bow_shot.mp3' },   // fallen-angel ARCHER devil — a flaming longbow on the wing (the faction's ranged specialist). AUDIBLE bow twang (was bow_silent_hits — Josh: "aint making bow noises")
  ...
  parnoneryx:        { name: 'Parnoneryx',         blindsense: true, glyph: '🐉', cr: '15',  hp: 340, ac: 32, toHit: 30, dmgDie: 8, dmgCount: 2, dmgBonus: 16, fort: 22, reflex: 11, will: 20, attacks: 3, flying: true, gold: [400, 720], arcane: true, sr: 26, dr: { amount: 10, bypass: 'magic' }, resist: { fire: 0, cold: 0.5, acid: 0.5 }, healer: { dice: 4, uses: 3 }, hellfire: { count: 3, dice: 12, die: 8, dc: 24, dtype: 'fire', verb: 'exhales a ROARING GOUT of DRAGONFIRE over the party', sound: '/audio/spell_hellfire.mp3' }, atkSound: '/audio/sword_eviscerate2_flaming.mp3' },   // BOSS — a GOLD DRAGON (18 HD, LG): bite/claw/wing (2d8+16) + a fire-breath, full arcane/divine, fire-immune, on the wing
...
// GOOD-ALIGNED flag (v3.37.139 — Josh: 'antipal also get smite good... read the
// anti-paladin page'): every rider of the two good gangs RADIATES GOOD. The
// antipaladin's new Smite Good / Detect Good key on it — and so does the
// Fiendish Boon's unholy weapon rider, which had NEVER fired: the swing checks
// target.good and no monster carried the flag until now.
for (const [_gk, _gv] of Object.entries(MON_GANGS)) {
  if (Array.isArray(_gv) && (_gv.includes('celestial') || _gv.includes('reclamation')) && MON[_gk]) MON[_gk].good = true;
}
