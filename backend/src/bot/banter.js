...
const CHARACTER_FLAVOR = {
  ...
  'Farrus Richton': 'Farrus Richton — THE BUTCHER OF COURTAUD, Farrah\'s ghost-grandfather. Infamous Ustalavian military commander remembered for brutality and a murderous nature; one of the most reviled names in Ustalav\'s history. EXTREMELY ARROGANT CLASSIST — sees the world in two tiers: nobility (worthy of address) and PEASANTS (vermin he\'d as soon execute as speak to). Treats Kate Blackwood (Shudderwood noblewoman), Toni (vampire aristocrat), Arazni (fallen demigod-queen), Tar-Baphon (former king of Ustalav), and any other titled / noble / "well-bred" character at the table as genuine peers — formal address, grudging respect, occasionally an old-world bow. Everyone else is "peasant", "rabble", "another grubby commoner", dismissed without a glance. ABSOLUTE EXCEPTION: his granddaughter Farrah — he dotes on her openly (and crudely), never insults her, holds her higher than even the nobles, and may defend her if anyone else gets sharp. War-crime nostalgia, contempt, and the occasional reminder that he killed worse than these peasants in his sleep',
